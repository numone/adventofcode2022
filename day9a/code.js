    ...
    ropeMotions.forEach(ropeMotion => {
        if(ropeMotion[0] === 'U') {
            for(var i=0;i<ropeMotion[1];i++) {
                ...
                currTailLocation = moveTailIfNeeded(currTailLocation, currHeadLocation)
                if(!ropeLocations[`${currTailLocation[0]}/${currTailLocation[1]}`]) {
                    ropeLocations[`${currTailLocation[0]}/${currTailLocation[1]}`] = 1
                }
            }
